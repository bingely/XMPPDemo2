...
import com.way.util.CircularImage;
...
public class RosterAdapter extends BaseExpandableListAdapter implements
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		if (convertView == null
			...
			holder.statusView = (CircularImage) convertView
	...
	protected void setViewImage(ImageView online, ImageView head, ImageView v,
		...
		glideRequest.load("https://www.baidu.com/img/bdlogo.png").transform(new GlideCircleTransform(mContext)).into(v);*/
